...
**Archived as of Sep 4th, 2025:** An newer implementation with a more recent version of DuckDB can be found in [this repo](https://github.com/embryo-labs/dynamic-predicate-transfer).
